...
install_v2ray() {
	...
	v2ray_download_link="https://gitee.com/qiyuechuanmei/v2ray-core/raw/master/linux/$v2ray_ver/v2ray-linux-${v2ray_bit}.zip"
	...
	if [[ $local_install ]]; then
		...
		git clone https://gitee.com/qiyuechuanmei/v2ray /etc/v2ray/233boy/v2ray
	fi
